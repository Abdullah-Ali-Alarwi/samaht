...
<div className="flex justify-center items-center">
  <div className="relative w-[90%] max-w-2xl mt-[100px]">
        <Swiper
          effect={"cards"}
          grabCursor={true}
        ...
        >
          {opinions.map((user) => (
            <SwiperSlide key={user.id} className="relative !overflow-visible ">
              <div className="relative bg-white border border-gray-200 rounded-xl shadow-md px-6 pt-20 pb-6 text-center">
                {/* الصورة والدائرة في كونتينر مستقل فوق الكارد */}
                <div className="absolute -top-16 left-1/2 -translate-x-1/2 flex flex-col items-center z-20">
                  {/* الدائرة الصفراء خلف الصورة */}
                  <div className="absolute w-32 h-32 bg-[#FEEA00] rounded-full -z-10"></div>
        ...
        {/* الأسهم المخصصة */}
        <div className="custom-prev hidden lg:block absolute top-1/2 -left-30 -translate-y-1/2 cursor-pointer z-50">
          <div className="bg-[#FEEA00] rounded-full w-12 h-12 flex items-center justify-center shadow-md">
            <ChevronLeft className="text-white w-6 h-6" />
          </div>
        </div>
        <div className="custom-next hidden lg:block absolute top-1/2 -right-30 -translate-y-1/2 cursor-pointer z-50">
          <div className="bg-[#FEEA00] rounded-full w-12 h-12 flex items-center justify-center shadow-md">

    ...
    <div className=" !overflow-hidden " >
      ...
      <div className="flex justify-center items-center w-[100%]  mt-10 lg:w-[70%]  mx-auto ">
        <div className="relative w-[90%] lg:w-[50%] max-w-4xl px-4 mt-12 mx-auto ">
          ...
          {/* الأسهم */}
          <div className="custom-prev hidden lg:flex absolute top-1/2 -left-16 -translate-y-1/2 cursor-pointer z-50">
            <div className="bg-[#FEEA00] rounded-full w-12 h-12 flex items-center justify-center shadow-md">
              <ChevronLeft className="text-white w-6 h-6" />
            </div>
          </div>
          <div className="custom-next hidden lg:flex absolute top-1/2 -right-16 -translate-y-1/2 cursor-pointer z-50">
            <div className="bg-[#FEEA00] rounded-full w-12 h-12 flex items-center justify-center shadow-md">

    ...
    <div className=' flex justify-center items-center'>
      ...
      <div className='flex justify-around  flex-col lg:flex-row gap-10 w-[100%] m-auto'>
        <div className=' flex flex-col  justify-around items-center border-1 border-gray-300 rounded-md m-auto w-[330px] h-[550px] p-7'>
            ...
            <div>
                <span> شهريا/</span>
                <span className='text-[#EE9322] text-[32px]'>$220</span>
            </div>
            <ul>
                <li className='flex items-center justify-end'><p className='text-[14px] text-gray-500'>لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم</p><FaCheck className='bg-green-600 text-white p-1 rounded-full' /></li>
                <li className='flex items-center justify-end'><p className='text-[14px] text-gray-500'>لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم</p><FaCheck className='bg-green-600 text-white p-1 rounded-full' /></li>
                <li className='flex items-center justify-end'><p className='text-[14px] text-gray-500'>لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم</p><FaCheck className='bg-green-600 text-white p-1 rounded-full' /></li>
                <li className='flex items-center justify-end'><p className='text-[14px] text-gray-500'>لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم</p><FaCheck className='bg-green-600 text-white p-1 rounded-full' /></li>
            </ul>
        ...
        <div className=' flex flex-col bg-yellow-100/30  justify-around items-center border-1 border-gray-300 rounded-md m-auto w-[330px] h-[550px] p-7'>
            ...
            <div>
                <span> شهريا/</span>
                <span className='text-[#EE9322] text-[32px]'>$120</span>
            </div>
            <ul>
                <li className='flex items-center justify-end'><p className='text-[14px] text-gray-500'>لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم</p><FaCheck className='bg-green-600 text-white p-1 rounded-full' /></li>
                <li className='flex items-center justify-end'><p className='text-[14px] text-gray-500'>لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم</p><FaCheck className='bg-green-600 text-white p-1 rounded-full' /></li>
        ...
        <div className=' flex flex-col  justify-around items-center border-1 border-gray-300 rounded-md m-auto w-[330px] h-[550px] p-7'>
            ...
            <div>
                <span> شهريا/</span>
                <span className='text-[#EE9322] text-[32px]'>$0</span>
            </div>
            <ul>
                <li className='flex items-center justify-end'><p className='text-[14px] text-gray-500'>لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم</p><FaCheck className='bg-green-600 text-white p-1 rounded-full' /></li>
                <li className='flex items-center justify-end'><p className='text-[14px] text-gray-500'>لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم</p><FaCheck className='bg-green-600 text-white p-1 rounded-full' /></li>

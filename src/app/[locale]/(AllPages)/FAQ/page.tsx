...
<div className='flex justify-center '>
   <div className=" w-full mt-[200px] lg:w-[70%] h-[308px] bg-[url('/image/CustmerQuestion.jpg')]  bg-[center_75%] text-center border-1 rounded-md border-yellow-100   relative bg-cover  ">
